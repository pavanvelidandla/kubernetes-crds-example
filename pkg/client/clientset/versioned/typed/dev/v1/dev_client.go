...
import (
	...
	"crds/pkg/client/clientset/versioned/scheme"
...
type DevV1Interface interface {
	...
	ConfigFromGitsGetter
	DatabasesGetter
}

// DevV1Client is used to interact with features provided by the dev.kubernetes.pavanvelidandla.com group.
type DevV1Client struct {
	restClient rest.Interface
}

func (c *DevV1Client) ConfigFromGits(namespace string) ConfigFromGitInterface {
	return newConfigFromGits(c, namespace)
}

func (c *DevV1Client) Databases(namespace string) DatabaseInterface {
