	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options meta_v1.ListOptions) (runtime.Object, error) {
				return client.DevV1().Databases(namespace).List(options)
			},
			WatchFunc: func(options meta_v1.ListOptions) (watch.Interface, error) {
				return client.DevV1().Databases(namespace).Watch(options)
			},
		},
		&dev_kubernetes_pavanvelidandla_com_v1.Database{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *databaseInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&dev_kubernetes_pavanvelidandla_com_v1.Database{}, defaultDatabaseInformer)
}
